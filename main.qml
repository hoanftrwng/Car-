    ...
    Rectangle {
        ...
        Item {
            ...
            Image {
                ...
                source: lowBeamActive ? "qrc:/assets/Low_beam_headlights_neon.svg" : "qrc:/assets/Low_beam_headlights_white.svg"
        ...
        Item {
            ...
            SideGauge {
                ...
                anchors.leftMargin: 190      // giảm từ 120 → 60
            }
            ...
            SideGauge {
                ...
                anchors.rightMargin: 190    // giảm từ 120 → 60
            }
        }
        ...
        ColumnLayout {
            ...
            Image { width: 50; height: 50; source: "qrc:/assets/Parking_lights.svg"; opacity: 1.0 }
            Image { width: 50; height: 50; source: "qrc:/assets/Lights.svg"; opacity: 1.0 }
            Image { width: 50; height: 50; source: "qrc:/assets/Low_beam_headlights_neon.svg"; opacity: lowBeamActive ? 1.0 : 1.0 }
            Image { width: 50; height: 50; source: "qrc:/assets/Rare_fog_lights.svg"; opacity: 1.0 }
        }
